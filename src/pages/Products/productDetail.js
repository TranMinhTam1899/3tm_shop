                            ...
                            <div className="product__info__content">
                                ...
                                <div className="quantity">
                                    <div className="custom">
                                        ...
                                        <input type="number" name="qty" id="sst" className="input-text qty" maxLength={12} value={quanty} />
                                        <button className="increase items-count" type="button" onClick={() => onUpdateQuanty(quanty + 1)}>
                                            <i className="fa fa-plus" aria-hidden="true"></i>
                                        </button>
                                    </div>
                                    <Link className="add_cart_btn" to="#" onClick={() => onAddToCart(product, quanty)}>Thêm vào giỏ hàng</Link>
                                </div>
                            </div>
                        </div>
                    </Col>
